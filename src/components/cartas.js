...
const cartas = [
  ...
  },
  {
    ...
    vantagem: "Ganhe 10 ouro",
    desvantagem: "O jogador escolhido ficará 1 rodada sem jogar",
    dica: "",
  },
  {
    titulo: "TESTE - Duas escolhas",
    pergunta: `Escolha uma das duas opções,
    opcoes: [
      { id: 1, texto: "Jogue novamente" },
      { id: 2, texto: "Ganhe 5 moedas" },
    ],
    respostaCorreta: [1,2],
    dificuldade: "normal",
    categorias: ["Inventário Florestal", "Conservação da Biodiversidade", "teste 1"],
    vantagem: "Escolha confirmada",
    desvantagem: "Perde 1 ponto de progresso.",
    dica: "",
  },
  {
