        ...
        <div className="flex flex-col items-center p-2 md:p-4 min-h-screen bg-gradient-to-b from-green-50 to-blue-50 font-sans">
            ...
            >
                <CardHeader className="pb-3">
                    ...
                    {(!ocultarCarta || cartaRevelada) ? (
                        <ScrollArea className="h-64 md:h-80 rounded-md border p-3 mt-2 bg-white/80"> {/* Altura aumentada */}
                            <div
                        ...
                        <div className="h-64 md:h-80 flex flex-col items-center justify-center space-y-2 rounded-md border p-3 mt-2 bg-gray-200"> {/* Altura aumentada */}
