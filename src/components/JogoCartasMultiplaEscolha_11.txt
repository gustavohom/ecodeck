...
// Importamos as cartas
import cartas from "./cartas";

// Tela Inicial
const TelaInicial = ({ onStartGame, onReset, categoriasDisponiveis, categoriasSelecionadas, setCategoriasSelecionadas }) => (
