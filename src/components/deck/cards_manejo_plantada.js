const manejo = [
  ...
  },
  {
    ...
    "opcoes": [
      // Correlacionar IDs com os Finais Possíveis
      { "id": 101, "texto": "Saí Abençoado (+1 Estrela Fixa e o bônus do caminho)" }, // Veio da água ou rocha
      { "id": 102, "texto": "Saí com meu item/bônus (+5 Progresso OU +1 Kit Reparo)" }, // Veio da armadilha
      { "id": 103, "texto": "Saí Ferido (-10 Progresso Total)" } // Veio da cautela errada
    ],
    "respostaCorreta": [101, 102, 103], // Todas são escolhas válidas que o jogador reporta
    "dificuldade": "dificil", // Por causa das múltiplas etapas e riscos
    "categorias": ["Teste_Caverna_Complexa"],
    "fontes": [],
